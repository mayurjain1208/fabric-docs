...
| Setting name | Description |
|------|-------|
|[Users can use Copilot and other features powered by Azure OpenAI](../fundamentals/copilot-fabric-overview.md#enable-copilot)|When this setting is enabled, users can access the features powered by Azure OpenAI, including Copilot, Data agent, AI functions and AI services. This setting can be managed at both the tenant and the capacity levels.  [Learn More](https://go.microsoft.com/fwlink/?linkid=2262239)<br><br>For customers in the EU Data Boundary, this setting adheres to Microsoft Fabric's EU Data Boundary commitments.  [Learn More](https://go.microsoft.com/fwlink/?linkid=2262243)<br><br>By enabling this setting, you agree to the  [Preview Terms](https://go.microsoft.com/fwlink/?linkid=2262241).|
